...
\end{figure}\todo{change to \ref{lpex}  maybe (x2 integer -> (0.75, 2, 3.5)\\
all integer -> (1,2,3)}
...
\todo{this is not surprising because there are obvious poly-time algorithms for this problem}
